...
#install.packages("tm",lib="C:/Users/jaggu/Documents/R/win-library/3.2",dependencies = TRUE)
#install.packages("ggplot2",lib="C:/Users/jaggu/Documents/R/win-library/3.2",dependencies = TRUE)
 #install.packages("lsa",lib="C:/Users/jaggu/Documents/R/win-library/3.2",dependencies = TRUE)
 #install.packages("scatterplot3d",lib="C:/Users/jaggu/Documents/R/win-library/3.2",dependencies = TRUE)
#install.packages("SnowballC",lib="C:/Users/jaggu/Documents/R/win-library/3.2",dependencies = TRUE)
#if !(require('SnowballC')) then install.packages("SnowballC")
library(tm,lib.loc="C:/Users/jaggu/Documents/R/win-library/3.2")
library(ggplot2,lib.loc="C:/Users/jaggu/Documents/R/win-library/3.2")
library(lsa,lib.loc="C:/Users/jaggu/Documents/R/win-library/3.2")
library(scatterplot3d,lib.loc="C:/Users/jaggu/Documents/R/win-library/3.2")
library(SnowballC,lib.loc="C:/Users/jaggu/Documents/R/win-library/3.2")
...
#setwd('C:/temp_games/Accelya Kale/R')
#list.files()
...
text <- c("The discipline of phenomenology is defined by its domain of study, 
  its methods, and its main results.",
          ...
          performing them. This experiential or first-person feature â?? that of being 
          experienced â?? is an essential part of the nature or structure of conscious 
          experience: as we say, â??I see / think / desire / do â?¦â? This feature is both 
          ...
          â?? unless its type is what interests us.",
          ...
          control). This style of â??neurophenomenologyâ? assumes that conscious 
          experience is grounded in neural activity in embodied action in appropriate 
          surroundings â?? mixing pure phenomenology with biological and physical 
